...
const points = [
  ...
  },
  {
    ...
    description:
      "You work directly with partners who have decades of industry experience. We do not staff projects with graduates learning on your budget.",
  },
];

export default function Differentiators() {
  return (
    <section id="results" className="py-24 border-y border-border relative">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted text-lg">
            Large consulting firms and system integrators earn more when
            projects get bigger. We earn trust by keeping projects right-sized
            and on track.
          </p>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-2 gap-8">
          {points.map((point, i) => (
            ...
            >
              <div className="flex-shrink-0 w-12 h-12 rounded-xl border border-border bg-surface flex items-center justify-center text-accent">
                {point.icon}
              </div>
              <div>
