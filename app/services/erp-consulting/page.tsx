    ...
    <PageLayout>
        ...
        <div className="space-y-8">
          <Reveal>
            <blockquote className="border-l-2 border-accent/30 pl-6">
              <p className="text-[15px] text-white/50 leading-relaxed italic">
              ...
              <footer className="mt-3 text-[13px] text-white/35">
      ...
      <ContentSection withBorder withGrain>
        ...
        <div className="space-y-12">
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">What does an ERP consultant do?</h3>
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">How much does an ERP consultant cost?</h3>
              <p className="text-[15px] text-white/50 leading-relaxed">
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">Do I need an ERP consultant?</h3>
              <p className="text-[15px] text-white/50 leading-relaxed">
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">What is the difference between an ERP consultant and a system integrator?</h3>
              <p className="text-[15px] text-white/50 leading-relaxed">
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">How do I choose an independent ERP consultant?</h3>
              <p className="text-[15px] text-white/50 leading-relaxed">
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">How long does ERP selection take?</h3>
              <p className="text-[15px] text-white/50 leading-relaxed">
