    ...
    <PageLayout>
      ...
      <ContentSection withBorder>
        ...
        <div className="space-y-12">
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">How much does SAP training cost in Ireland?</h3>
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">Can you train our team on SAP Enable Now so we can maintain content ourselves?</h3>
              <p className="text-[15px] text-white/50 leading-relaxed">
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">Do you deliver SAP training remotely?</h3>
              <p className="text-[15px] text-white/50 leading-relaxed">
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">How do you handle training for a multi-site rollout?</h3>
              <p className="text-[15px] text-white/50 leading-relaxed">
