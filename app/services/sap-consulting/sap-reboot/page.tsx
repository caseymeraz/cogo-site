  ...
  return (
    <PageLayout>
      ...
      <ContentSection withBorder withGrain>
        ...
        <Reveal delay={0.6}>
          <p className="text-[15px] text-muted mt-10 leading-relaxed">
      ...
      <ContentSection withBorder>
        ...
        <div className="space-y-16">
          <Reveal>
            <div>
              <h3 className="text-[20px] font-semibold text-foreground mb-4">Phase 1: Discovery and health check (4-6 weeks)</h3>
              <div className="text-[15px] text-muted leading-[1.8] space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4 mt-6">
                  {[
                    ...
                    <div key={i} className="p-4 rounded-xl bg-surface border border-border">
                      <p className="text-[14px] font-medium text-foreground mb-1">{item.label}</p>
          ...
          <Reveal>
            <div>
              <h3 className="text-[20px] font-semibold text-foreground mb-4">Phase 2: Recovery roadmap (2-3 weeks)</h3>
              <div className="text-[15px] text-muted leading-[1.8] space-y-4">
                ...
                <ul className="space-y-3 mt-4">
                  <li className="flex gap-3 items-start">
                    ...
                    <span><strong className="text-foreground font-medium">Quick wins (0-3 months):</strong> Configuration corrections, unused customisation removal, licence optimisation, and targeted training.</span>
                  </li>
                  <li className="flex gap-3 items-start">
                    <span className="w-1 h-1 rounded-full bg-accent/60 mt-[0.65em] flex-shrink-0" />
                    <span><strong className="text-foreground font-medium">Medium-term improvements (3-9 months):</strong> Process redesign, data cleansing programmes, and reporting improvements.</span>
                  </li>
                  <li className="flex gap-3 items-start">
                    <span className="w-1 h-1 rounded-full bg-accent/60 mt-[0.65em] flex-shrink-0" />
                    <span><strong className="text-foreground font-medium">Strategic initiatives (9-18 months):</strong> Implementing unused SAP modules, integration improvements, or preparing for S/4HANA migration.</span>
                  </li>
                </ul>
          ...
          <Reveal>
            <div>
              <h3 className="text-[20px] font-semibold text-foreground mb-4">Phase 3: Embed and sustain</h3>
              <div className="text-[15px] text-muted leading-[1.8] space-y-4">
                <p>
          ...
          <Reveal>
            <div>
              <h3 className="text-[20px] font-semibold text-foreground mb-4">Phase 4: Future enhancements</h3>
              <div className="text-[15px] text-muted leading-[1.8] space-y-4">
                <p>
      ...
      <ContentSection withBorder>
        ...
        <div className="space-y-12">
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-foreground mb-3">How long does a SAP Reboot take?</h3>
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-foreground mb-3">Is a reboot worth it if we are planning to move to S/4HANA anyway?</h3>
              <p className="text-[15px] text-muted leading-relaxed">
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-foreground mb-3">What does a SAP Reboot cost?</h3>
              <p className="text-[15px] text-muted leading-relaxed">
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-foreground mb-3">Can COGO do the reboot remotely?</h3>
              <p className="text-[15px] text-muted leading-relaxed">
