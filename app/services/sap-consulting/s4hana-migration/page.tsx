    ...
    <PageLayout>
      ...
      <ContentSection withBorder withGrain>
        ...
        <Reveal>
          <div className="mt-8 grid md:grid-cols-2 gap-6">
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[16px] font-semibold text-white/90 mb-2">In-memory architecture</h3>
            ...
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[16px] font-semibold text-white/90 mb-2">Simplified data model</h3>
                <p className="text-[14px] text-white/50 leading-relaxed">
            ...
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[16px] font-semibold text-white/90 mb-2">Embedded analytics</h3>
                <p className="text-[14px] text-white/50 leading-relaxed">
            ...
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[16px] font-semibold text-white/90 mb-2">Fiori user experience</h3>
                <p className="text-[14px] text-white/50 leading-relaxed">
            ...
            <SpotlightCard className="md:col-span-2">
              <div className="p-7">
                <h3 className="text-[16px] font-semibold text-white/90 mb-2">Cloud, on-premise, or hybrid</h3>
                <p className="text-[14px] text-white/50 leading-relaxed">
      ...
      <ContentSection withBorder withGrain>
        ...
        <div className="space-y-8">
          <Reveal>
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[18px] font-semibold text-white/90 mb-3">Greenfield (new implementation)</h3>
                ...
                <p className="text-[14px] text-white/50 leading-relaxed mb-3">
                  <strong className="text-white/70">When it makes sense:</strong> Your current ECC system is heavily customised and the customisations no longer serve the business. You want to adopt SAP&apos;s standard processes. You are merging multiple ECC instances. Your chart of accounts or master data is fundamentally flawed.
                </p>
                <p className="text-[14px] text-white/50 leading-relaxed">
                  <strong className="text-white/70">The reality:</strong> Longest timeline (typically 24 to 36 months). Highest cost (you are essentially implementing ERP from the ground up). Greatest organisational disruption. Best opportunity to redesign processes, if you have the appetite for it.
                </p>
              </div>
            </SpotlightCard>
          </Reveal>
          <Reveal delay={0.1}>
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[18px] font-semibold text-white/90 mb-3">Brownfield (system conversion)</h3>
                <p className="text-[14px] text-white/50 leading-relaxed mb-3">
                ...
                <p className="text-[14px] text-white/50 leading-relaxed mb-3">
                  <strong className="text-white/70">When it makes sense:</strong> Your current processes work well and your customisations are justified. You need to preserve historical transactional data for regulatory or audit reasons. You want the shortest path to S/4HANA with the least organisational disruption. Your ECC system is relatively &quot;clean.&quot;
                </p>
                <p className="text-[14px] text-white/50 leading-relaxed">
                  <strong className="text-white/70">The reality:</strong> Shorter timeline (typically 12 to 24 months). Lower cost than greenfield, but not cheap. Custom code remediation alone can be a major workstream. You inherit all the problems of your current system unless you actively address them.
                </p>
              </div>
            </SpotlightCard>
          </Reveal>
          <Reveal delay={0.2}>
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[18px] font-semibold text-white/90 mb-3">Selective data transition (hybrid)</h3>
                <p className="text-[14px] text-white/50 leading-relaxed mb-3">
                ...
                <p className="text-[14px] text-white/50 leading-relaxed mb-3">
                  <strong className="text-white/70">When it makes sense:</strong> You want the process redesign benefits of greenfield but need to bring across specific historical data. You are carving out a business unit (post-merger or divestiture scenarios). You have multiple ECC systems and want to consolidate while cherry-picking the best processes from each.
                </p>
                <p className="text-[14px] text-white/50 leading-relaxed">
                  <strong className="text-white/70">The reality:</strong> Moderate timeline (18 to 30 months). Requires specialist tooling (SNP CrystalBridge, SAP&apos;s own LTMC, or similar). Most flexible approach, but also the most complex to plan and govern.
                </p>
              </div>
            </SpotlightCard>
          </Reveal>
        ...
        <Reveal>
          <p className="mt-8 text-[15px] text-white/50 leading-relaxed">
      ...
      <ContentSection withBorder>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Reveal>
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[18px] font-semibold text-white/90 mb-3">RISE with SAP</h3>
                <p className="text-[14px] text-white/50 leading-relaxed mb-3">
          ...
          <Reveal delay={0.1}>
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[18px] font-semibold text-white/90 mb-3">GROW with SAP</h3>
                <p className="text-[14px] text-white/50 leading-relaxed mb-3">
      ...
      <ContentSection withBorder withGrain>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Reveal delay={0}>
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[16px] font-semibold text-white/90 mb-2">S/4HANA Finance</h3>
                <p className="text-[14px] text-white/50 leading-relaxed">
          ...
          <Reveal delay={0.1}>
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[16px] font-semibold text-white/90 mb-2">Supply Chain Management</h3>
                <p className="text-[14px] text-white/50 leading-relaxed">
          ...
          <Reveal delay={0.2}>
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[16px] font-semibold text-white/90 mb-2">Manufacturing</h3>
                <p className="text-[14px] text-white/50 leading-relaxed">
          ...
          <Reveal delay={0.3}>
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[16px] font-semibold text-white/90 mb-2">Procurement</h3>
                <p className="text-[14px] text-white/50 leading-relaxed">
      ...
      <ContentSection withBorder>
        ...
        <Reveal>
          <div className="overflow-x-auto mb-10">
            <table className="w-full text-[14px] text-white/55">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="text-left py-3 pr-4 text-white/70 font-medium">Migration approach</th>
                  <th className="text-left py-3 px-4 text-accent font-medium">Typical duration</th>
                  <th className="text-left py-3 pl-4 text-white/70 font-medium">Range</th>
                </tr>
              </thead>
              <tbody className="[&_tr]:border-b [&_tr]:border-white/[0.06]">
                <tr>
                  <td className="py-3 pr-4 text-white/70">Brownfield (system conversion)</td>
                  <td className="py-3 px-4">12-18 months</td>
                  <td className="py-3 pl-4">9-24 months</td>
                </tr>
                <tr>
                  <td className="py-3 pr-4 text-white/70">Selective data transition</td>
                  <td className="py-3 px-4">18-24 months</td>
                  <td className="py-3 pl-4">15-30 months</td>
                </tr>
                <tr>
                  <td className="py-3 pr-4 text-white/70">Greenfield (new implementation)</td>
      ...
      <ContentSection withBorder withGrain>
        ...
        <div className="space-y-8">
          <Reveal>
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[18px] font-semibold text-white/90 mb-3">Pre-programme (before you spend serious money)</h3>
                <ul className="space-y-2 text-[14px] text-white/50 leading-relaxed">
                  <li className="flex gap-3 items-start">
                    <span className="w-1 h-1 rounded-full bg-accent/60 mt-[0.65em] flex-shrink-0" />
                    <span><strong className="text-white/70">Landscape assessment:</strong> We audit your current ECC environment, including custom code volume, data quality, integration landscape, and organisational readiness.</span>
                  </li>
                  <li className="flex gap-3 items-start">
                    <span className="w-1 h-1 rounded-full bg-accent/60 mt-[0.65em] flex-shrink-0" />
                    <span><strong className="text-white/70">Migration path recommendation:</strong> Greenfield, brownfield, or selective, based on your business objectives, not what generates the most consulting fees.</span>
                  </li>
                  <li className="flex gap-3 items-start">
                    <span className="w-1 h-1 rounded-full bg-accent/60 mt-[0.65em] flex-shrink-0" />
                    <span><strong className="text-white/70">Business case development:</strong> Realistic cost and benefit modelling that your CFO will actually trust.</span>
                  </li>
                  <li className="flex gap-3 items-start">
                    <span className="w-1 h-1 rounded-full bg-accent/60 mt-[0.65em] flex-shrink-0" />
                    <span><strong className="text-white/70">SI selection support:</strong> We help you write the RFP, evaluate responses, and negotiate contracts.</span>
                  </li>
                </ul>
              </div>
            </SpotlightCard>
          ...
          <Reveal delay={0.1}>
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[18px] font-semibold text-white/90 mb-3">During the programme</h3>
                <ul className="space-y-2 text-[14px] text-white/50 leading-relaxed">
                  <li className="flex gap-3 items-start">
                    <span className="w-1 h-1 rounded-full bg-accent/60 mt-[0.65em] flex-shrink-0" />
                    <span><strong className="text-white/70">Programme assurance:</strong> Independent oversight of your SI&apos;s delivery. We attend steering committees, review milestone deliverables, and flag risks before they become problems.</span>
                  </li>
                  <li className="flex gap-3 items-start">
                    <span className="w-1 h-1 rounded-full bg-accent/60 mt-[0.65em] flex-shrink-0" />
                    <span><strong className="text-white/70">Change management:</strong> Ensuring your people are prepared for new processes and technology. This is where most S/4HANA programmes fail, and it is where COGO adds the most value.</span>
                  </li>
                  <li className="flex gap-3 items-start">
                    <span className="w-1 h-1 rounded-full bg-accent/60 mt-[0.65em] flex-shrink-0" />
                    <span><strong className="text-white/70">Testing governance:</strong> Making sure user acceptance testing is rigorous, scenario-based, and covers your real business processes.</span>
                  </li>
                  <li className="flex gap-3 items-start">
                    <span className="w-1 h-1 rounded-full bg-accent/60 mt-[0.65em] flex-shrink-0" />
                    <span><strong className="text-white/70">Data migration oversight:</strong> Your data is only as good as your cleansing effort. We help you define data quality standards and hold your SI accountable to them.</span>
                  </li>
                </ul>
              </div>
            </SpotlightCard>
          ...
          <Reveal delay={0.2}>
            <SpotlightCard>
              <div className="p-7">
                <h3 className="text-[18px] font-semibold text-white/90 mb-3">Post-go-live</h3>
                <ul className="space-y-2 text-[14px] text-white/50 leading-relaxed">
                  <li className="flex gap-3 items-start">
                    <span className="w-1 h-1 rounded-full bg-accent/60 mt-[0.65em] flex-shrink-0" />
                    <span><strong className="text-white/70">Hypercare support:</strong> The first 90 days after go-live are critical. We help you manage the transition from project mode to business-as-usual.</span>
                  </li>
                  <li className="flex gap-3 items-start">
                    <span className="w-1 h-1 rounded-full bg-accent/60 mt-[0.65em] flex-shrink-0" />
                    <span><strong className="text-white/70">Benefits realisation:</strong> Tracking whether the benefits in your business case are actually being delivered, and taking corrective action when they are not.</span>
                  </li>
                  <li className="flex gap-3 items-start">
                    <span className="w-1 h-1 rounded-full bg-accent/60 mt-[0.65em] flex-shrink-0" />
                    <span><strong className="text-white/70">Continuous improvement:</strong> Identifying quick wins and optimisation opportunities once your users have settled into the new system.</span>
                  </li>
                </ul>
              </div>
            </SpotlightCard>
      ...
      <ContentSection withBorder>
        ...
        <div className="space-y-12">
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">How long does an SAP S/4HANA migration take?</h3>
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">What is the difference between SAP S/4HANA Cloud and on-premise?</h3>
              <p className="text-[15px] text-white/50 leading-relaxed">
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">Can we migrate from SAP ECC to S/4HANA in phases?</h3>
              <p className="text-[15px] text-white/50 leading-relaxed">
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">What happens to our custom ABAP code during migration?</h3>
              <p className="text-[15px] text-white/50 leading-relaxed">
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">Is RISE with SAP mandatory for S/4HANA?</h3>
              <p className="text-[15px] text-white/50 leading-relaxed">
          ...
          <Reveal>
            <div>
              <h3 className="text-[18px] font-semibold text-white/85 mb-3">Do we need to change our business processes during an S/4HANA migration?</h3>
              <p className="text-[15px] text-white/50 leading-relaxed">
